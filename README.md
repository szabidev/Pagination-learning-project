...
- FIX ISSUW WHEN INPUT KEYWORDS ARE DELETED, SHOW ALL IMAGES
- SHOW IMAGES FOR ALL KEYWORDS EX. NATURE / ANIMALS
- MAKE A DEBOUNCER FROM SCRATCH FOR THE FILTER INPUT -> CALL HANDLETAGCHANGE AFTER DEBOUNCE
- AFTER FILTER IS APPLIED, AND IMAGES ARE DISPLAYED, JUMP TO 1ST PAGE OF AVAILABLE PAGES
